...
public class delivery_deliveries {
    ...
    public delivery_deliveries(String deliveryId, String orderId, String customerAddress,
    ...
    public StringProperty numOfItemsProperty() {
        return numOfItems;
    }
