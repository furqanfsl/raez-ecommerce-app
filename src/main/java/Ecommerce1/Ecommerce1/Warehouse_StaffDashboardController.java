...
import Ecommerce1.Ecommerce1.service.Warehouse_DeliveryService;
import Ecommerce1.Ecommerce1.service.Warehouse_ReportService;
import Ecommerce1.Ecommerce1.service.WarehouseService;
...
public class Warehouse_StaffDashboardController {
    ...
    private void onAddWarehouse() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/WarehouseAddDialog.fxml"));
    ...
    private void onAddProduct() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/WarehouseAddProductDialog.fxml"));
    ...
    private void onTransferStock() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/WarehouseTransferStockDialog.fxml"));
    ...
    private void onEditProduct() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/WarehouseEditProductDialog.fxml"));
    ...
    private void onEditWarehouse() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/WarehouseEditDialog.fxml"));
