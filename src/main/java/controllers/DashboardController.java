...
public class DashboardController {
    ...
    private void goToDrivers() {
        SceneSwitcher.switchScene("drivers.fxml", totalOrdersLabel);
    }

    @FXML
    private void goToOrders() {
        SceneSwitcher.switchScene("orders.fxml", totalOrdersLabel);
    }

    @FXML
    private void logout() {
        SceneSwitcher.switchScene("login.fxml", totalOrdersLabel);
    }
}