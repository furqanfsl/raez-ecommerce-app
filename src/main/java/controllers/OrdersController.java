...
public class OrdersController {
    ...
    @FXML
    private TableView<delivery_deliveries> ordersTable;

    @FXML
    private TableColumn<delivery_deliveries, String> idCol;

    @FXML
    private TableColumn<delivery_deliveries, String> customerCol;

    @FXML
    private TableColumn<delivery_deliveries, String> addressCol;

    @FXML
    private TableColumn<delivery_deliveries, String> statusCol;

    @FXML
    private TableColumn<delivery_deliveries, String> driverCol;

    @FXML
    private TableColumn<delivery_deliveries, String> itemsCol;

    @FXML
    private TableColumn<delivery_deliveries, String> dateCol;

    private final ObservableList<delivery_deliveries> deliveries = FXCollections.observableArrayList();
    private FilteredList<delivery_deliveries> filteredDeliveries;
    ...
    private void addOrder() {
        ...
        delivery_deliveries delivery = new delivery_deliveries(
                deliveryId,
                orderId,
                address,
                status,
    ...
    private void openSelectedOrder() {
        delivery_deliveries selected = ordersTable.getSelectionModel().getSelectedItem();
        if (selected != null) {
            selectedOrderId = selected.getDeliveryId();
            SceneSwitcher.switchScene("DeliveriesOrderDetail.fxml", ordersTable);
        }
    }

    @FXML
    private void goBack() {
        SceneSwitcher.switchScene("DeliveriesDashboard.fxml", ordersTable);
    }
}