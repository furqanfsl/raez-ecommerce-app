...
public class DriversController {
    ...
    @FXML
    private TableView<delivery_drivers> driversTable;

    @FXML
    private TableColumn<delivery_drivers, String> idCol;

    @FXML
    private TableColumn<delivery_drivers, String> nameCol;

    @FXML
    private TableColumn<delivery_drivers, String> licenseCol;

    @FXML
    private TableColumn<delivery_drivers, String> phoneCol;

    @FXML
    private TableColumn<delivery_drivers, String> emailCol;

    private final ObservableList<delivery_drivers> drivers = FXCollections.observableArrayList();
    private FilteredList<delivery_drivers> filteredDrivers;
    ...
    private void addDriver() {
        ...
        delivery_drivers driver = new delivery_drivers("", name, license, phone, email);
    ...
    private void deleteSelectedDriver() {
        delivery_drivers selected = driversTable.getSelectionModel().getSelectedItem();
        if (selected != null) {
    ...
    @FXML
    private void goBack() {
        SceneSwitcher.switchScene("DeliveriesDashboard.fxml", driversTable);
    }
}