...
public class DriverDAO {
    ...
    public static List<Driver> getAllDrivers() {
        ...
        String sql = "SELECT driverID, driverName, licenceNumber, phoneNum, email FROM Driver ORDER BY driverID";
    ...
    public static boolean addDriver(Driver driver) {
        String sql = "INSERT INTO Driver (licenceNumber, phoneNum, email, driverName) VALUES (?, ?, ?, ?)";
